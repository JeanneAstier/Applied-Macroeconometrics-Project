/* ESTIMATION ON DATASET 3 - SCENARIO 4
 *
 ...
 *
 * It estimates a model on simulated dataset 3, fixing parameter Phi_p at 150% of its calibrated value.
 */
...
crhoa,0.98073,.01,.9999,NORMAL_PDF,0.98073,0.00456092095963085;
crhob,0.21559,.01,.9999,NORMAL_PDF,0.21559,0.117281712129385;
crhog,0.96661,.01,.9999,NORMAL_PDF,0.96661,0.0102479266195655;
crhoqs,0.63125,.01,.9999,NORMAL_PDF,0.63125,0.0557404700374871;
crhoms,0.20532,.01,.9999,NORMAL_PDF,0.20532,0.0612356105546438;
crhopinf,0.97898,.01,.9999,NORMAL_PDF,0.97898,0.0104076894650062;
crhow,0.97787,.001,.9999,NORMAL_PDF,0.97787,0.00925834758474751;
cmap,0.8288,0.01,.9999,NORMAL_PDF,0.8288,0.050881234261759;
cmaw,0.92347,0.01,.9999,NORMAL_PDF,0.92347,0.0211841922196717;
csadjcost,6.3649,2,15,NORMAL_PDF,6.3649,1.05692951515226;
csigma,1.255,0.25,3,NORMAL_PDF,1.255,0.118932754109202;
chabb,0.78784,0.001,0.99,NORMAL_PDF,0.78784,0.0477660967632902;
cprobw,0.76493,0.3,0.95,NORMAL_PDF,0.76493,0.0363042697213427;
csigl,2.5218,0.25,10,NORMAL_PDF,2.5218,0.568629932381334;
cprobp,0.55554,0.5,0.95,NORMAL_PDF,0.55554,0.0365704798984099;
cindw,0.52169,0.01,0.99,NORMAL_PDF,0.52169,0.0989712079344291;
cindp,0.20526,0.01,0.99,NORMAL_PDF,0.20526,0.0807935641001188;
czcap,0.37881,0.01,1,NORMAL_PDF,0.37881,0.0886605887641177;
//cfc,1.6601,1.0,3,NORMAL_PDF,1.6601,0.0718387082289207;
crpi,1.8984,1.0,3,NORMAL_PDF,1.8984,0.1613629449409;
crr,0.87586,0.5,0.975,NORMAL_PDF,0.87586,0.0157372170347873;
cry,0.12632,0.001,0.5,NORMAL_PDF,0.12632,0.0257149761812062;
crdy,0.13648,0.001,0.5,NORMAL_PDF,0.13648,0.0219874964468445;
constepinf,0.65585,0.1,2.0,NORMAL_PDF,0.65585,0.0968395580328618;
constebeta,0.13645,0.01,2.0,NORMAL_PDF,0.13645,0.054481189414329;
constelab,1.1582,-10.0,10.0,NORMAL_PDF,1.1582,0.794789280249803;
ctrend,0.50603,0.1,0.8,NORMAL_PDF,0.50603,0.0142186497249211;
cgy,0.59712,0.01,2.0,NORMAL_PDF,0.59712,0.0905085631307889;
calfa,0.20182,0.01,1.0,NORMAL_PDF,0.20182,0.0180900525151255;
end;
...
//Full MC simulation 
estimation(optim=('MaxIter',200),datafile=SW_simul3,mode_file=usmodel_shock_decomp_mode,mode_compute=0,first_obs=1,presample=4,lik_init=2,prefilter=0,mh_replic=20000,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,posterior_graph,bayesian_irf,irf=150,irf_shocks=(eb), nograph);
